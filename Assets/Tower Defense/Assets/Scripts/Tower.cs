...
public class Tower : MonoBehaviour
{
    ...
    // Tower Properties
    [SerializeField] private float _shootPower = 1f; // 🚨 ALTERADO PARA float (1f)
    ...
    // Função que é usada para pegar o sprite no Tower Head
    ...
    public void ShootTarget()
    {
        ...
        if (_runningShootDelay <= 0f)
        {
            ...
            // Passa o _shootPower como float (e espera que SetProperties no Bullet tenha sido alterado)
